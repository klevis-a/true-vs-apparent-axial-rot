"""Plot HT yx'y'' axial rotation for individual subjects
...
if __name__ == '__main__':
    ...
    config_dir = Path(mod_arg_parser("Plot HT yx'y'' axial rotation for individual subjects", __package__, __file__))
    ...
    fig.suptitle("HT yx'y'' Axial Orientation", fontsize=12, fontweight='bold', y=0.99)
